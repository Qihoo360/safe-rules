...
&emsp;&emsp; [c-cpp-rules.json](https://github.com/Qihoo360/safe-rules/blob/main/c-cpp-rules.json)：C/C++ 规则结构化文档  
&emsp;&emsp; [cpp-ub-list.md](https://github.com/Qihoo360/safe-rules/blob/main/cpp-ub-list.md)：C++ 未定义行为列表与标准导读
